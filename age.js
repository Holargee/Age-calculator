...
var year = Math.floor(dif / (1000 * 60 * 60 * 24 * 365.25));
var month = Math.floor(dif % (1000 * 60 * 60 * 24 * 365.25) / (1000*60*60*24*30.44));
var day = Math.floor( dif % (1000*60*60*24*30.44) / (1000 * 60 * 60 * 24 ))
